...
type InitOptions = IPropTypes['init'] & Record<string, any>;

/**
 * tinymce 编辑器最小接口
 * 核心包经 public/tinymce 自托管加载，无需安装 npm 类型
 */
...
/**
 * tinymce 扩展配置
 * images_upload_handler/setup 不在 @tinymce/tinymce-vue 的 InitOptions 类型中，单独声明后展开
 */
